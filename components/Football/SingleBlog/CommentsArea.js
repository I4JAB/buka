            ...
            <ol className="comment-list">
                    ...
                    <article className="comment-body">
                        <footer className="comment-meta">
                            <div className="comment-author vcard">
                                <img src="/images/football/footb-user1.jpg" className="avatar" alt="image" />
                    ...
                    <ol className="children">
                        <li className="comment">
                            <article className="comment-body">
                                <footer className="comment-meta">
                                    <div className="comment-author vcard">
                                        <img src="/images/football/footb-user2.jpg" className="avatar" alt="image" />
                            ...
                            <ol className="children">
                                <li className="comment">
                                    <article className="comment-body">
                                        <footer className="comment-meta">
                                            <div className="comment-author vcard">
                                                <img src="/images/football/footb-user3.jpg" className="avatar" alt="image" />
                ...
                <li className="comment">
                    <article className="comment-body">
                        <footer className="comment-meta">
                            <div className="comment-author vcard">
                                <img src="/images/football/footb-user4.jpg" className="avatar" alt="image" />
