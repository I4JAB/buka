...
const NextMatch = () => {
    ...
    const commingSoonTime = () => {
        let endTime = new Date("September 9, 2022 16:00:00 PDT");
                ...
                <div className="row">
                            ...
                            <div className="content">
                                <div className="row align-items-center">
                                    <div className="col-lg-5 col-md-5">
                                        <h2>Next Match</h2>
                                        <span className="sub-title">World Cup - 9 September, 2022</span>
                                    </div>
                    ...
                    <div className="col-lg-6 col-md-12">
                        <div className="next-match-image">
                            <img src="/images/football/footb-field.jpg" alt="image" />
                        </div>
                    </div>
                </div>
            </div>
